  ...
  return (
    <div className="min-h-screen bg-background-main p-lg font-sans">
      <div className="container mx-auto">
        ...
        {/* Main Content Area: Filter Sidebar + Course List */}
        <div className="flex flex-col lg:flex-row lg:space-x-lg">
            {/* Filter Sidebar */}
            <aside className="lg:w-1/4 mb-lg lg:mb-0">
                <FilterSidebar currentFilters={filters} onFilterChange={handleSidebarFilterChange} />
            </aside>
